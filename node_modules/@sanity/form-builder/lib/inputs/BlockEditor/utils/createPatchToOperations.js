  ...
  return function patchToOperations(patch, editorValue) {
    ...
    if (patch.path.length > 1) {
      if (patch.path[1] === 'markDefs') {
        ...
        var blockNode = controller.value.document.getNode(patch.path[0]._key);
        var node = findEditorChildNodeFromBlockChildKey(blockNode, findLastKey(patch.path)); // eslint-disable-next-line max-depth

...
class Editor extends _react.default.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "handleEditorFocus", () => {
      var setFocus = this.props.setFocus;
      setFocus();
    });
    ...
    _defineProperty(this, "handleShowBlockDragMarker", (pos, node) => {
      ...
      if (editorDOMNode instanceof HTMLElement) {
        ...
        var top = pos === 'after' ? `${bottomPos}px` : `${topPos}px`;
    ...
    _defineProperty(this, "handlePaste", (event, editor, next) => {
      ...
      return resolved.then(result => {
        ...
        if (result && result.insert) {
          onPatch(_PatchEvent.default.from([(0, _PatchEvent.insert)(result.insert, 'after', result.path || focusPath)]));
          onLoading({
            paste: null
          });
    ...
    }), (0, _slateInsertBlockOnEnter.default)(_blockTools.EDITOR_DEFAULT_BLOCK_TYPE), (0, _OnDropPlugin.default)(), (0, _SetBlockStylePlugin.default)(), (0, _ToggleAnnotationPlugin.default)(), (0, _ExpandToWordPlugin.default)(), (0, _WrapSpanPlugin.default)(), (0, _InsertInlineObjectPlugin.default)(_props.type), (0, _InsertBlockObjectPlugin.default)(), (0, _UndoRedoPlugin.default)({
  ...
  trackFocusPath() {
    ...
    if (!focusPathIsSingleBlock) {
      if (focusPath[1] && focusPath[1] === 'children' && focusPath[2]) {
        ...
        if (!inline) {
          throw new Error(`Could not find a inline with key ${focusPath[2]._key}, something is amiss.`);
        }

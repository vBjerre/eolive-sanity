...
(0, _storybook.storiesOf)('Buttons', module).addDecorator(_knobs.withKnobs).add('Default', () => {
  ...
  return _react.default.createElement(_router.RouterProvider, {
    ...
    disabled: disabled,
    loading: loading
  }, "Simple"), _react.default.createElement("h2", null, "Colors"), _react.default.createElement(_buttonGrid.default, null, _react.default.createElement(_default.default, {
    onClick: action('clicked'),
    disabled: disabled,
    loading: loading
  ...
  }, _react.default.createElement(_buttonGrid.default, {
  ...
  }, _react.default.createElement(_buttonGroup.default, null, (0, _range2.default)(0, qtyButtons).map(i => {
    return _react.default.createElement(_default.default, {
      kind: buttonKind,
      color: buttonColor,
      key: i,

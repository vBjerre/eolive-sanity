...
class AssetHandler {
  ...
  downloadAsset(assetDoc, dstPath) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var stream = yield requestStream({
        url,
        headers
      });
      ...
      var hash = yield writeHashedStream(path.join(_this2.tmpDir, dstPath), stream);
      var type = assetDoc._type === 'sanity.imageAsset' ? 'image' : 'file';
      var id = `${type}-${hash}`;
